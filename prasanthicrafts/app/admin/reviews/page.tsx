                    ...
                    {reviews.length === 0 ? (
                        ...
                        <div key={review.id} className="bg-white p-5 rounded-2xl border border-gray-100 hover:shadow-sm transition-all">
                            ...
                            <div className="flex gap-0.5 mt-3">
                                {[...Array(5)].map((_, i) => (
                                    <svg key={i} className={`w-4 h-4 ${i < review.rating ? 'text-yellow-400 fill-current' : 'text-gray-200 fill-current'}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
